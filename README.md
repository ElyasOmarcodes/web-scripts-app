...
|---|---|---|
| **اکاونټونه** — په ټاب بار کې «وړل / راوړل» | CSV: نوم، کټګوري، د کوکیزو حالت، پروکسي، پېژندګلوي | CSV |
| **پروکسي** — په سر کې د تبادلې تڼۍ | CSV: پته، پورټ، حالت، وتنځی IP، ځای | CSV یا هماغه ساده لیست چې خرڅوونکي درکړی |
| **سکریپټونه** — په سر کې د تبادلې تڼۍ | JSON · **Python (Selenium)** · **JavaScript (Playwright)** · CSV لنډیز | JSON |
