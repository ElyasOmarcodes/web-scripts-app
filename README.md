...
| **کارونه** — فلټر، لټون، هر کار خپل رنګ | **د کار تنظیمات** — اکاونټونه، بصري/پټ، د کمپیوټر وس |
...
| **د سکریپټ خپله فاصله** | **اکاونټونه** — د کوکیزو حالت او د هر یو پروکسي |
| ![د اکاونټ پروکسي](docs/screenshots/09-account-proxy.png) | ![د براوزر پېژندګلوي](docs/screenshots/19-account-identity.png) |
| **د اکاونټ پروکسي** — ټاکلې، تصادفي، یا هېڅ | **د براوزر پېژندګلوي** — ۱۰۰ وسیلې، په درې کچو |
| ![د کارډ منو](docs/screenshots/20-account-menu.png) | ![نوی اکاونټ](docs/screenshots/10-add-account.png) |
| **د اکاونټ منو** — نوم، کوکیز، پروکسي، پېژندګلوي، ړنګول | **نوی اکاونټ** |
| ![پروکسي](docs/screenshots/11-proxies.png) | ![پروکسي زیاتول](docs/screenshots/12-add-proxy.png) |
| **پروکسي** — ژوندی/مړ حالت، وتنځی ای‌پي، ځای | **پروکسي زیاتول** — لیست یو ځای پېسټ کړئ |
| ![ثبتونکی](docs/screenshots/13-recorder.png) | ![تنظیمات](docs/screenshots/14-settings.png) |
| **ثبتونکی** | **تنظیمات** |
| ![د اکاونټ ساتنه](docs/screenshots/15-settings-safety.png) | ![پېښې](docs/screenshots/16-activity.png) |
| **د اکاونټ ساتنه** | **پېښې** |
| ![مرسته](docs/screenshots/17-help.png) | ![نوې لارښوونه](docs/screenshots/18-record-sheet.png) |
| **مرسته** | **نوې لارښوونه** |
